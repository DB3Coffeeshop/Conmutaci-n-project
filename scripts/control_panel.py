...
#        tree.column('Code Studen',anchor='center',width=30)
    ...
    def cbox_category_change(self,event):
        category_one=self.category_first_Cbox.get()
        self.category_second_Cbox['values'] = []
        self.category_second_Cbox['values'] = ['chan', 'ge', 'd']
        #
        #ENVIAR INFO PARA TRAER 2 CATEGORIA
        #
